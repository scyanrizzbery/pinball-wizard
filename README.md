...
An autonomous agent that learns to play real-world pinball using computer vision and reinforcement learning.

## 🌟 Features

- **Hybrid Architecture**: Works on both a simulated physics engine and real hardware (Raspberry Pi + Webcam).
- **Reinforcement Learning**: Uses PPO (Proximal Policy Optimization) to learn gameplay strategies.
- **Computer Vision**: Real-time ball tracking and flipper detection using OpenCV.
