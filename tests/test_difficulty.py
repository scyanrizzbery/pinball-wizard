...
class TestAIDifficulty:
    ...
    def test_difficulty_presets(self, zone_manager, hardware):
        ...
        # Easy Mode
        agent_easy = ReflexAgent(zone_manager, hardware, difficulty='easy')
        ...
        # Medium Mode
        agent_medium = ReflexAgent(zone_manager, hardware, difficulty='medium')
        ...
        # Hard Mode
        agent_hard = ReflexAgent(zone_manager, hardware, difficulty='hard')
    ...
    def test_default_difficulty(self, zone_manager, hardware):
        ...
        agent = ReflexAgent(zone_manager, hardware)
    ...
    def test_invalid_difficulty(self, zone_manager, hardware):
        ...
        agent = ReflexAgent(zone_manager, hardware, difficulty='invalid_mode')
